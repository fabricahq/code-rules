...
func renderProjectGuide(configName string) []byte {
	...
	).Replace("> **Generated by Code Rules. Do not edit this file manually.**\n> Regenerate with `code-rules project build` using the configuration shown below. Init and sync also refresh this guide. Keep project-specific notes in a separate file.\n\n" + projectGuideTemplate)
