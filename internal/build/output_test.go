...
func TestPrepareRetainsTermsWithoutActiveRules(t *testing.T) {
	...
	if !strings.HasPrefix(string(got.Files["libraries/team/README.md"]), "> **Generated by Code Rules.") || !strings.Contains(string(got.Files["libraries/team/README.md"]), "Do not edit these copies") {
		t.Fatal("missing copied-terms notice")
	}
