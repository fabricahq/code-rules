...
Parser acceptance will not prove that a remote exists, is reachable, or is safe to fetch. Proposed future constraints:
...
These are future design constraints, not remote-fetch implementation work in this change.
