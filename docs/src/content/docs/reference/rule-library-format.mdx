...
See [License a library](/guides/license-rules/) for publisher guidance and the boundary with the consuming project's license.

## Related guides

- [Write a rule](/guides/write-rules/) walks through writing an individual rule.
- [Create a library](/start-here/create-library/) walks through organizing and sharing a library.
