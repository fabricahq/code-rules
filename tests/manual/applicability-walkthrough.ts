...
switch (action) {
  ...
  case 'library-licenses': {
    ...
    for (const path of [
      ...
      assert(rendered.includes('vendor/licensed/LICENSE.md'));
      assert(rendered.includes('vendor/licensed/NOTICE.md'));
