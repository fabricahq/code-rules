...
PRs 17-25 have merged into `go-migration` after user approval, resolved feedback, final review, and passing checks. PRs #26-27 remain open for human review. Passing CI or automated reviews does not authorize merging these PRs.
...
| #27 | Full-rule groups | codex/go-inline-groups | codex/go-licensed-output | /walkthrough/pr27 |
