...
`build.RenderIndexes` produces `RULES.md` and group summary indexes for a resolved rule set. Every summary links to the complete standalone rule. Effective local group guidance takes precedence. Empty groups remain discoverable.
